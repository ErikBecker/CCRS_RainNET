...
from tensorflow.keras.layers import Activation, Conv2D, MaxPooling2D, Dropout, concatenate, UpSampling2D, Input

def rainnet(input_shape=(512, 512, 7), mode="regression"):
